...
public class CouponController {
	...
	public ResponseEntity<List<CouponDto>> getAllCoupon(
			@RequestParam(value = "pageNumber", required = false, defaultValue = "5") int pageNumber,
			@RequestParam(value = "pageSize", required = false, defaultValue = "4") int pageSize,
			@RequestParam(value = "sortBy", required = false, defaultValue = "percentDiscount") String sortBy,
			@RequestParam(value = "diretion", required = false, defaultValue = "ASC") Direction dir) {
	...
	public ResponseEntity<List<CouponDto>> test4(@PathVariable("couponCode") int couponCode,
			@PathVariable("percentDiscount") int percentDiscount) {
